...
- **Confirm the built-in redaction preset names** against the live API before the demo leans on them. The stage-then-apply flow is verified end to end, but with a literal `text` target; the PII preset identifiers are still assumed.
