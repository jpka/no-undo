...
| P8 | Fix `.github/workflows/ci.yml` — it runs 1 of 4 test files, so the full suite is a local claim. | Test-count claim | ✅ **DONE** — CI now runs `npm test` (the full glob; 191 tests). |
